...
| `docs/game/bgm-presets.md` | 組み込み BGM 22 曲のファイル名・用途と Suno 用の制作プロンプト（管理ページへ入れる手順つき） |
