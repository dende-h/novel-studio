    ...
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-lg">
          <DialogHeader>
            <DialogTitle className="font-serif text-on-surface">この欄で使える記法</DialogTitle>
            <DialogDescription>
              書いた記号は「プレビュー」で反映されます（本文の執筆エリアではマークダウンは使えません）。
            </DialogDescription>
          </DialogHeader>
          <DialogBody>
            <Section title="用語集の参照">
              <Row syntax="@">
                打つと用語集のサジェストが開き、選ぶと [[名前]]
                が入ります。無い語はその場で登録できます。
              </Row>
              <Row syntax="[[用語]]">
