...
describe('組み込みの BGM プリセット（枠だけ・20 曲）', () => {
  it('20 曲のキーが一意で、preset:bgm/ の形を持つ', () => {
    expect(PRESET_BGMS).toHaveLength(20)
