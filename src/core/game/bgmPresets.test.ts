...
describe('組み込みの BGM プリセット（枠だけ・18 曲）', () => {
  it('18 曲のキーが一意で、preset:bgm/ の形を持つ', () => {
    expect(PRESET_BGMS).toHaveLength(18)
